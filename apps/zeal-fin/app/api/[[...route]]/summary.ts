...
import { calculatePercentageChange, fillMissingDays } from "@/lib/appUtils";
...
const app = new Hono().get(
  ...
  async (c) => {
    ...
    const expensesChage = calculatePercentageChange(
    ...
    return c.json({
      date: {
        ...
        remainingChange,
        imcomeAmount: currentPeriod?.income,
        incomeChange,
